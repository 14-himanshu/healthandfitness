...
function Home() {
  ...
  const testimonials = [
    ...
    { name: "Emma Thompson", role: "Yoga Instructor", text: "Simple, elegant, and secure. I recommend BMI Health to all my clients who are just starting their wellness journey.", rating: 5 }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="h-14 px-8 text-lg font-bold shadow-lg shadow-primary/25 bg-gradient-to-r from-primary to-blue-600 hover:opacity-90" asChild>
                  <Link to="/signup">Start Free Trial <ArrowRight className="ml-2 h-5 w-5" /></Link>
                </Button>
                <Button variant="outline" size="lg" className="h-14 px-8 text-lg font-bold border-border/50" asChild>
